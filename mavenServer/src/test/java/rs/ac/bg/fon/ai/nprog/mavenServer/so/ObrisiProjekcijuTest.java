...
//		Statement statement = connection.createStatement();
	...
	@Test
	public void testObrisiProjekcijuUspesno() throws Exception {
		...
		showtime.setShowtimeId(1);
		 ...
		 obrisiProjekciju=new ObrisiProjekciju(showtime);
		obrisiProjekciju.executeOperation();
	...
	public void testObrisiProjekcijuNeuspesno() throws Exception {
