...
//		Statement statement = connection.createStatement();
	...
	public void testSacuvajUBaziNeuspesnoKapacitetSalePopunjen() throws Exception {
		String query = "INSERT into reservation values (1,'Ivona Ivonic','ivona@gmail.com',1,1)";
		Statement statement = connection.createStatement();
		statement.executeUpdate(query);
		connection.commit();
		...
		Showtime showtime = new Showtime();
		showtime.setHall(new Hall(1, "Hall1", 1));
		showtime.setShowtimeId(1);
		Reservation reservation = new Reservation("Pera Peric", "pera@gmail.com", new User(1), showtime);
